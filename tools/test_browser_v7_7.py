#!/usr/bin/env python3
"""Testes visuais/DOM da V7.7 sem depender de deploy ou servidor externo."""
...
WEB = ROOT / "web"
EVIDENCE = ROOT / "docs/evidencias/V7.7"
...
"""
    export = "<script>window.__raidV77 = { raidState, renderResults };</script>"
...
def run() -> None:
    with sync_playwright() as pw:
        ...
        for width, height in [(320, 568), (390, 844), (430, 932), (720, 900)]:
            ...
            page.evaluate(
                """team => {
                  window.__raidV77.raidState.selectedBoss = 'goblin';
                  window.__raidV77.raidState.selectedElement = 'fire';
                  window.__raidV77.renderResults([team]);
                }""",
                SAMPLE_TEAM,
            )
    ...
    print("Resultado visual V7.7: 5/5 grupos aprovados.")
